...
exports.Create = async function (req, res, next) {
    try {
        ...
        const datacreate = await REPUTATIONCARDBG.create(req.body);
...
exports.Read = async function (req, res, next) {
    try {
        ...
        const total = await REPUTATIONCARDBG.countDocuments(filter);
        const data = await REPUTATIONCARDBG.find(filter)
            .sort({ createdAt: -1 })
            .skip(skip)
...
exports.Update = async function (req, res, next) {
    try {
        ...
        const updatedCard = await REPUTATIONCARDBG.findByIdAndUpdate(
            req.params.id,
            req.body,
...
exports.Delete = async function (req, res, next) {
    try {
        const deleted = await REPUTATIONCARDBG.findByIdAndDelete(req.params.id);
