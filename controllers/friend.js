...
exports.Create = async function (req, res, next) {
    try {
        ...
        const datacreate = await FRIENDCARDBG.create(req.body);
...
exports.Read = async function (req, res, next) {
    try {
        ...
        const total = await FRIENDCARDBG.countDocuments(filter);
        const data = await FRIENDCARDBG.find(filter)
            .sort({ createdAt: -1 })
            .skip(skip)
...
exports.Update = async function (req, res, next) {
    try {
        ...
        const updatedCard = await FRIENDCARDBG.findByIdAndUpdate(
            req.params.id,
            req.body,
...
exports.Delete = async function (req, res, next) {
    try {
        const deleted = await FRIENDCARDBG.findByIdAndDelete(req.params.id);
